...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.EntityRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.EntityUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.ModuleFunction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.ModuleRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.ModuleUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.LoginLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.UserDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.UserLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Infos.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Infos.Entities.MessageReceive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Infos.Entities.MessageReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Systems.Entities.AuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Systems.Entities.AuditOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Systems.Entities.AuditProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.EntityRole", b =>
                {
                    ...
                    b.HasOne("colibri.kanban.Identity.Entities.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.EntityUser", b =>
                {
                    ...
                    b.HasOne("colibri.kanban.Identity.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.Module", b =>
                {
                    b.HasOne("colibri.kanban.Authorization.Entities.Module", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("colibri.kanban.Authorization.Entities.ModuleFunction", b =>
                {
                    ...
                    b.HasOne("colibri.kanban.Authorization.Entities.Module", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.Organization", b =>
                {
                    b.HasOne("colibri.kanban.Identity.Entities.Organization", null)
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.Role", b =>
                {
                    b.HasOne("colibri.kanban.Infos.Entities.Message", null)
            ...
            modelBuilder.Entity("colibri.kanban.Identity.Entities.UserDetail", b =>
                {
                    b.HasOne("colibri.kanban.Identity.Entities.User", "User")
                        .WithOne("UserDetail")
                        .HasForeignKey("colibri.kanban.Identity.Entities.UserDetail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("colibri.kanban.Infos.Entities.Message", b =>
                {
                    b.HasOne("colibri.kanban.Identity.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("colibri.kanban.Infos.Entities.MessageReceive", b =>
                {
                    b.HasOne("colibri.kanban.Infos.Entities.Message", "Message")
                        .WithMany("Receives")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("colibri.kanban.Infos.Entities.MessageReply", b =>
                {
                    b.HasOne("colibri.kanban.Infos.Entities.Message", "BelongMessage")
                        .WithMany()
                        .HasForeignKey("BelongMessageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("colibri.kanban.Infos.Entities.Message", "ParentMessage")
                        .WithMany("Replies")
                        .HasForeignKey("ParentMessageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("colibri.kanban.Infos.Entities.MessageReply", "ParentReply")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("colibri.kanban.Systems.Entities.AuditEntity", b =>
                {
                    b.HasOne("colibri.kanban.Systems.Entities.AuditOperation", "Operation")
            ...
            modelBuilder.Entity("colibri.kanban.Systems.Entities.AuditProperty", b =>
                {
                    b.HasOne("colibri.kanban.Systems.Entities.AuditEntity", "AuditEntity")
                        .WithMany("Properties")
