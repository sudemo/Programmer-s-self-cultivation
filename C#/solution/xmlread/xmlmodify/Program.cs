...
namespace xmlmodify
{
    class Program
    {
        ...
        static  void Main()
        {
            ...
            XmlNode oldChild = xmldoc.SelectSingleNode("setting/PNEnable");
            XmlElement element = (XmlElement)xmldoc.SelectSingleNode("setting/PNEnable");
            string  name = element.GetAttribute("hexcapFlag");
